    ...
    <main>
        ...
        <section class="ul-breadcrumb ul-2-banner">
            <div class="ul-container">
                <h1 class="ul-breadcrumb-title">Blogs List</h1>
                <div class="ul-breadcrumb-nav">
                    <a href="index.html">Home</a>
                    <span class="separator"><i class="flaticon-next"></i></span>
                    <span class="current">Blogs List</span>
                </div>
            </div>
        </section>
            ...
            <div class="ul-container">
                <div class="row ul-bs-row gy-5 gx-4">
                    ...
                    <div class="col-lg-8 col-md-7">
                            ...
                            <div class="ul-blog-details-txt">
                                <div class="ul-inner-blog-infos">
                                    ...
                                    <div class="ul-inner-blog-info">
                                        ...
                                        <span class="text">12 March 2025</span>
                                    </div>
                                    <!-- single info -->
                                    <div class="ul-inner-blog-info">
                                        <span class="icon"><i class="flaticon-sms"></i></span>
                                        <span class="text">0 Comments</span>
                                    </div>
                                </div>
                                <h2 class="ul-blog-details-title ul-inner-blog-title"><a href="blog-details.html">How to Set Up and Use Mobile Banking Safely</a></h2>
                                ...
                                <a href="blog-details.html" class="ul-btn">READ MORE <i class="flaticon-arrow-up-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="ul-blog-details-top ul-inner-blog">
                            <div class="ul-blog-details-img">
                                <img src="assets/img/blog-big-3.jpg" alt="Image">
                            </div>
                        ...
                        <div class="ul-blog-details-top ul-inner-blog">
                            <div class="ul-blog-details-img">
                                <img src="assets/img/blog-big-2.jpg" alt="Image">
                            </div>
