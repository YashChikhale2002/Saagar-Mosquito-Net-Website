...
<body class="home-2">
   ...
   <?php include 'include/header.php'; ?>
    ...
    <main>
        ...
        <section class="ul-breadcrumb ul-2-banner d-none">
            <div class="ul-container">
                <h1 class="ul-breadcrumb-title">Error 404</h1>
        ...
        <!-- ERROR SECTION START -->
        <section class="ul-404 ul-section-spacing">
            <div class="ul-container">
                <div class="ul-404-img"><img src="assets/img/404.svg" alt="Image"></div>
                <h1 class="ul-404-title">Oops! Something Went Wrong</h1>
                <p class="ul-404-descr">We're sorry, but an unexpected error occurred. Please refresh the page or try again later. If the problem continues, contact our support team for immediate assistance. Thank you for your patience.</p>
                <a href="index.html" class="ul-btn">BACK TO HOME <i class="flaticon-arrow-up-right"></i></a>
            </div>
        </section>
        <!-- ERROR SECTION END -->
    </main>
