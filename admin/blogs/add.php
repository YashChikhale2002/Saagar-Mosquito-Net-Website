...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($schema_type)) {
        $schemaData = [
            ...
            'author'           => ['@type' => 'Organization', 'name' => 'Sagar Enterprises'],
            'publisher'        => ['@type' => 'Organization', 'name' => 'Sagar Enterprises'],
                                    ...
                                    <div class="tab-pane fade show active" id="tab-meta">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" name="canonical_url" class="form-control"
                                                placeholder="https://Saagar-Mosquito-Net-Website.com/blog/high-strength-steel-grades"
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <div class="serp-preview">
                                                <div class="serp-url">Saagar-Mosquito-Net-Website.com › blog › <span id="serpSlug">blog-slug</span></div>
