    ...
    <main>
        ...
        <section class="ul-breadcrumb ul-2-banner">
            <div class="ul-container">
                <h1 class="ul-breadcrumb-title">Team Members</h1>
                <div class="ul-breadcrumb-nav">
                    <a href="index.html">Home</a>
                    <span class="separator"><i class="flaticon-next"></i></span>
                    <span class="current">Team Members</span>
                </div>
            </div>
        </section>
        ...
        <section class="ul-2-team ul-section-spacing">
            <div class="ul-container">
                <div class="row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 ul-bs-row">
                    <!-- single team member -->
                    <div class="col">
                        <div class="ul-2-team-member">
                            ...
                            <div class="ul-2-team-member-info">
                                <span class="ul-2-team-member-name"><a href="team-details.html">John Doe</a></span>
                    ...
                    <div class="col">
                        <div class="ul-2-team-member">
                            ...
                            <div class="ul-2-team-member-info">
                                <span class="ul-2-team-member-name"><a href="team-details.html">Jasmin thomas</a></span>
                    ...
                    <div class="col">
                        <div class="ul-2-team-member">
                            ...
                            <div class="ul-2-team-member-info">
                                <span class="ul-2-team-member-name"><a href="team-details.html">Ashley Smith</a></span>
                    ...
                    <div class="col">
                        <div class="ul-2-team-member">
                            ...
                            <div class="ul-2-team-member-info">
                                <span class="ul-2-team-member-name"><a href="team-details.html">Peter Smith</a></span>
